...
final class Version20221215112852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE ending_at ending_at DATE DEFAULT NULL, CHANGE createdAt createdAt DATE NOT NULL, CHANGE consultant_id author_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE ending_at ending_at DATETIME DEFAULT NULL, CHANGE createdAt createdAt DATETIME NOT NULL, CHANGE author_id consultant_id INT NOT NULL');
